...
A summary of biomedical QA datasets surveyed in our paper [Biomedical Question Answering: A Survey of Approaches and Challenges](https://dl.acm.org/doi/10.1145/3490238).
...
| --------------------- | ------------------------- | --------------------------- | -------------------------------------------------------- | --------------------- | ----------- | --------------------------- | --------------------------- |
| [BioASQ Task B Phase A](#bioasq-task-b) | 3.7k                      | MAP                         | [33.04 (document) / 68.21 (snippet)](https://link.springer.com/chapter/10.1007/978-3-030-58219-7_16) | IR | Scientific  | Retrieval                   | 2021.3             |
...
| [emrQA](#emrqa)       | 455k                      | EM, F1                     | [76.3, 81.86](https://arxiv.org/abs/2004.02288) | MRC                   | Clinical    | Extraction                  | 2021.3            |
